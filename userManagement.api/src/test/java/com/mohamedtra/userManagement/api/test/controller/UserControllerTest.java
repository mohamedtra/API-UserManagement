...
public class UserControllerTest {
	...
	@Test
		...
		restUserMockMvc.perform(MockMvcRequestBuilders
				.get("/users/search/{lastname}", "TRAORE")
				.accept(MediaType.APPLICATION_JSON))
        		.andDo(print())
        		.andExpect(status().isOk())
		 ...
		 * @Ignore
		 * 
		 * @Test public void addUser() throws Exception { User user = new
		 * User("Jean","BOSCO", "jeanbo@gmail.com", LocalDate.of(2000,2,12), new
		 * Address("34 rue de la paix","paris","Cannes",06400));
